...
export declare class ColumnMenuItemComponent implements OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ColumnMenuItemComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ColumnMenuItemComponent, "kendo-grid-columnmenu-item", never, {
    "expanded": "expanded";
    "icon": "icon";
    "text": "text";
    "selected": "selected";
