...
export declare class ViewListComponent implements OnChanges, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    private intlChange;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ViewListComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ViewListComponent, "kendo-calendar-viewlist", never, {
    "isActive": "isActive";
    "min": "min";
    "max": "max";
